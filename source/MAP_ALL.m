function [v1, v2] = MAP_ALL(fr1, fr2, v1_init, v2_init, num_iters, sigma)
  [h, w] = size(fr1);
  v1 = v1_init;
  v2 = v2_init;
  lambda_d = 20;
  ...
  for k = 1:num_iters
    ...
    for j = 2:h-1
      for i = 2:w-1
        ...
        p = Ug*(1-occ) + lambda_d*Ud + lambda_l*Ul + lambda_o*Uo;
        ...
        while(1)
          ...
          p_new = Ug*(1-occ) + lambda_d*Ud + lambda_l*Ul + lambda_o*Uo;
          %p_new = Ug + lambda_d*Ud + lambda_l*Ul + lambda_o*Uo;
